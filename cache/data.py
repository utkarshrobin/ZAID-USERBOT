RAID = [
    ...
    "TOHRI MAYI K BUR 👅",
    "TERA BAAP CHHAKKA ",
    "GAND MAAR DENGE BHOSDIKE",
    "TOHAR BAHEEN CHOD DEB BSDK",
    "HAHAHAHHAHAHHAAAAAHAHAHAHAHAHHAHAHAHAHAHAHHA 🆙🆒😙",
    "TERI MAA KI CHUT ME LWDAA DAL DUNGA 😍",
    "TERE MAA KA MAMTA AUR BAAP KA CHUT 🤣😍",
    "SPEED PKD KALAP GYA KYA ",
    "RANDI KE AULAT 😋😛",
    "BAAP SE LDAI",
    "RRRRRRRRRRRAAAAAAAANNNNNNNNDDDDDDIIIIIII ",
    "MAAAAAA--CHUDAAAAAA",
    "LLLLLLUUUNNNNNNDDDDD LEE LEE",
    "AAJAA ",
    " MADARCHOD ",
    "TERI ",
    "MAA KA  ",
    "BHOSDA  ",
    "TERI MAA KI KALI CHUT ",
    "ME APNA LWDAA DAAL DUNGA BSDK",
    "TOHAR",
    "BAHEEN",
    "KA CHUT LWDEE",
    "TERI MAA KE GAAND ME MERA LWDAAA",
